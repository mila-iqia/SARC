...
def test_query():
    ...
    start = datetime.datetime(2023, 5, 1, tzinfo=datetime.UTC)
    end = datetime.datetime(2023, 6, 1, tzinfo=datetime.UTC)
    response = query(
        id,
        start=start,
        end=end,
    ...
    start_time = datetime.datetime.fromtimestamp(start_time, datetime.UTC)
