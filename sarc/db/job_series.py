...
class JobSeriesDB(SQLModel, table=True):
    ...
    # datetime_utc_field, not plain datetime: a bare annotation maps the ORM
    # column to DateTime(timezone=False), so window-bound params are sent as
    # naive timestamps and get reinterpreted in the session's TimeZone.
