...
# Kept out of the OpenAPI schema and interactive /docs page: these endpoints
# serve the dashboard's own JS, whose contract lives in metrics.html, and
# they return ad hoc dicts a schema would not describe.
router = APIRouter(
    prefix="/dash",
