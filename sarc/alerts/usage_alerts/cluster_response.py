...
def check_cluster_response(time_interval: timedelta = timedelta(days=7), cluster_name = None):
    """
    ...
    clusters = [cluster_name] if cluster_name else get_available_clusters()
    result = True
